          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-3 ml-auto">
              <Button 
                ...
                variant="outline"
                className="border-purple-600 text-white bg-purple-600 hover:bg-purple-700 hover:text-white rounded-xl"
              >
                Sign In
              </Button>
              <Button 
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center pt-20">
            ...
            <div className="text-left lg:text-left">
              ...
              <Button 
                ...
                variant="outline"
                size="lg"
                className="bg-purple-600 text-white hover:bg-purple-700 text-lg px-8 py-3 rounded-xl"
              >
                Get Started
            ...
            <div className="relative flex justify-end pr-8 lg:mr-8">
              {/* Phone frame */}
